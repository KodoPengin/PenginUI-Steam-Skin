"steam/cached/aboutdialog.res"
{
	...
	styles {
		frame {
			render_bg {
				1="fill( x1-350,y0,x1,y1, almostblack )"
				2="gradient( x1-350,y0,x1-349,y1, launch2, launch0 )"
				0="image(x1-345,y0+14,x1,y1, graphics/gi_about)"
			}
	...
	layout
	{
	place { control="Button1" height=0 length=0 }
	}
}